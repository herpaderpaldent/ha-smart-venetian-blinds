"""
API Client for smart_venetian_blinds.
...
class SmartVenetianBlindsApiClientError(Exception):
    """Base exception to indicate a general API error."""


class SmartVenetianBlindsApiClientCommunicationError(
    SmartVenetianBlindsApiClientError,
):
    """Exception to indicate a communication error with the API."""


class SmartVenetianBlindsApiClientAuthenticationError(
    SmartVenetianBlindsApiClientError,
):
...
def _verify_response_or_raise(response: aiohttp.ClientResponse) -> None:
    ...
    Raises:
        SmartVenetianBlindsApiClientAuthenticationError: For 401/403 errors.
        aiohttp.ClientResponseError: For other HTTP errors.

    """
    if response.status in (401, 403):
        msg = "Invalid credentials"
        raise SmartVenetianBlindsApiClientAuthenticationError(
            msg,
        )
    response.raise_for_status()


class SmartVenetianBlindsApiClient:
    """
    ...
    async def async_get_data(self) -> Any:
        ...
        Raises:
            SmartVenetianBlindsApiClientAuthenticationError: If authentication fails.
            SmartVenetianBlindsApiClientCommunicationError: If communication fails.
            SmartVenetianBlindsApiClientError: For other API errors.
    ...
    async def _api_wrapper(
        ...
        try:
            ...
            raise SmartVenetianBlindsApiClientCommunicationError(
                msg,
            ) from exception
            ...
            raise SmartVenetianBlindsApiClientError(
                msg,
            ) from exception
