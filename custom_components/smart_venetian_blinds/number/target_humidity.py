"""Target humidity number for smart_venetian_blinds."""

from __future__ import annotations

from typing import TYPE_CHECKING

from custom_components.smart_venetian_blinds.api import SmartVenetianBlindsApiClientError
...
class SmartVenetianBlindsHumidityNumber(NumberEntity, SmartVenetianBlindsEntity):
