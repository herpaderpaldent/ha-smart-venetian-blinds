"""Connectivity binary sensor for smart_venetian_blinds."""
...
class SmartVenetianBlindsConnectivitySensor(BinarySensorEntity, SmartVenetianBlindsEntity):
    """Connectivity sensor for smart_venetian_blinds."""
