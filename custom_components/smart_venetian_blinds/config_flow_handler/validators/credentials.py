...
from custom_components.smart_venetian_blinds.api import SmartVenetianBlindsApiClient
...
async def validate_credentials(hass: HomeAssistant, username: str, password: str) -> None:
    ...
    Raises:
        SmartVenetianBlindsApiClientAuthenticationError: If credentials are invalid.
