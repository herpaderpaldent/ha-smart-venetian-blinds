...
from custom_components.smart_venetian_blinds.config_flow_handler.validators import validate_credentials
...
ERROR_MAP = {
    "SmartVenetianBlindsApiClientAuthenticationError": "auth",
    "SmartVenetianBlindsApiClientCommunicationError": "connection",
}
