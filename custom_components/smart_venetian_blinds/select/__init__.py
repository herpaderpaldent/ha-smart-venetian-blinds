"""Select platform for smart_venetian_blinds."""
...
from .fan_speed import ENTITY_DESCRIPTIONS as FAN_SPEED_DESCRIPTIONS, SmartVenetianBlindsFanSpeedSelect
...
async def async_setup_entry(
    ...
    async_add_entities(
        SmartVenetianBlindsFanSpeedSelect(
