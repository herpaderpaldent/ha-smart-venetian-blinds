...
- `entity/` - Base entity class (`SmartVenetianBlindsEntity`)
...
- All entities inherit: `(PlatformEntity, SmartVenetianBlindsEntity)` - order matters for MRO
...
- Adjust log level: `custom_components.smart_venetian_blinds: debug` in `config/configuration.yaml`
