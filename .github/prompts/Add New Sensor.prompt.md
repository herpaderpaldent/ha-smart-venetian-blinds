...
- Create new sensor file in `custom_components/smart_venetian_blinds/sensor/`
- Inherit from `SmartVenetianBlindsEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Smart Venetian Blinds."""
...
class SmartVenetianBlinds[SensorName]Sensor(
...
- Entity: `custom_components/smart_venetian_blinds/sensor/[sensor_name].py`
- Platform: `custom_components/smart_venetian_blinds/sensor/__init__.py`
- Translations: `custom_components/smart_venetian_blinds/translations/*.json`
