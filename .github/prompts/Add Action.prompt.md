...
**File:** `custom_components/smart_venetian_blinds/services.yaml`
...
[action_name]:
  ...
  target:
    entity:
      ...
      # OR
      integration: smart_venetian_blinds
...
Create `custom_components/smart_venetian_blinds/service_actions/[action_name].py`:

```python
"""[Action name] service action for Smart Venetian Blinds."""
...
**File:** `custom_components/smart_venetian_blinds/__init__.py`
...
**File:** `custom_components/smart_venetian_blinds/const.py`
...
3. Find service action: `smart_venetian_blinds.[action_name]`
...
- **Service actions directory:** `custom_components/smart_venetian_blinds/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/smart_venetian_blinds/services.yaml` (legacy filename)
- **Icons:** `custom_components/smart_venetian_blinds/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/smart_venetian_blinds/translations/*.json` under `services` key (legacy)
