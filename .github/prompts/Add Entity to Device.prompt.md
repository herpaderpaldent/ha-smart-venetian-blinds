...
- Inherit from `SmartVenetianBlindsEntity` and platform base class
...
- Entity: `custom_components/smart_venetian_blinds/[platform]/[entity_name].py`
- Platform: `custom_components/smart_venetian_blinds/[platform]/__init__.py`
