...
**Directory:** `custom_components/smart_venetian_blinds/[platform]/`
...
```python
"""[Platform] platform for Smart Venetian Blinds."""
...
from .entity import SmartVenetianBlindsEntity
from .[entity_file] import SmartVenetianBlinds[EntityName]
...
async def async_setup_entry(
    ...
    coordinator: SmartVenetianBlindsDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            SmartVenetianBlinds[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Smart Venetian Blinds."""
...
class SmartVenetianBlinds[EntityName](
    SmartVenetianBlindsEntity,
    [PlatformEntityClass],
):
...
Add platform to `custom_components/smart_venetian_blinds/manifest.json`:
...
- [ ] Entity class inherits from both `SmartVenetianBlindsEntity` and platform class
...
- **Class prefix:** `SmartVenetianBlinds`
- **Base entity:** `SmartVenetianBlindsEntity` in `entity/base.py`
- **Coordinator:** `SmartVenetianBlindsDataUpdateCoordinator`
