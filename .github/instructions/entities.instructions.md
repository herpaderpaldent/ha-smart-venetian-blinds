...
- **`entity/`** - Base entity classes (inherit `SmartVenetianBlindsEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, SmartVenetianBlindsEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import SmartVenetianBlindsEntity`
