...
- `SmartVenetianBlindsApiClientError` (Base)
- `SmartVenetianBlindsApiClientCommunicationError` (Network, timeout, HTTP errors)
- `SmartVenetianBlindsApiClientAuthenticationError` (401, 403, invalid credentials)
