...
[![Open your Home Assistant instance and open a repository inside the Home Assistant Community Store.](https://my.home-assistant.io/badges/hacs_repository.svg)](https://my.home-assistant.io/redirect/hacs_repository/?owner=jpawlowski&repository=ha-smart-venetian-blinds&category=integration)
...
[![Open your Home Assistant instance and start setting up a new integration.](https://my.home-assistant.io/badges/config_flow_start.svg)](https://my.home-assistant.io/redirect/config_flow_start/?domain=smart_venetian_blinds)
...
3. Search for "Smart Venetian Blinds"
...
Find all entities in **Settings** → **Devices & Services** → **Smart Venetian Blinds** → click on the device.
...
### `smart_venetian_blinds.example_action`
...
```yaml
service: smart_venetian_blinds.example_action
data:
  # Add your parameters here
```

### `smart_venetian_blinds.reload_data`
...
```yaml
service: smart_venetian_blinds.reload_data
```
...
4. Check the integration diagnostics (Settings → Devices & Services → Smart Venetian Blinds → 3 dots → Download diagnostics)
...
**Made with ❤️ by [@herpaderpaldent][user_profile]**
