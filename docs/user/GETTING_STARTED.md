# Getting Started with Smart Venetian Blinds

This guide will help you install and set up the Smart Venetian Blinds custom integration for Home Assistant.
...
1. Download the latest release from the [releases page](https://github.com/herpaderpaldent/ha-smart-venetian-blinds/releases)
2. Extract the `smart_venetian_blinds` folder from the archive
3. Copy it to `custom_components/smart_venetian_blinds/` in your Home Assistant configuration directory
...
4. Select entities from "Smart Venetian Blinds"

Example entities card:

```yaml
type: entities
title: Smart Venetian Blinds
entities:
...
- Report issues at [GitHub Issues](https://github.com/herpaderpaldent/ha-smart-venetian-blinds/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com/herpaderpaldent/ha-smart-venetian-blinds/discussions)
